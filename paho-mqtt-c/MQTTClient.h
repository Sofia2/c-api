...
typedef struct 
{
	...
	/** The directory containing the PEM public digital certificates trusted by the client. */
	const char* capath;
...
#define MQTTClient_SSLOptions_initializer { {'M', 'Q', 'T', 'S'}, 0, NULL, NULL, NULL, NULL, NULL, NULL, 1 }
